...
const Poster = () => {
  ...
  useEffect(() => {
    ...
    nextIcon = nextBtn.children[0];
    prevIcon = prevBtn.children[0];
    dotsBox = document.getElementsByClassName("dotBox");
    dots = dotsBox.children;
    Buttons = document.querySelectorAll(".photoBtnBox");
  ...
  return (
    <div>
      <div className={styles.posterContainer}>
        <button className={styles.sphotoBtnBox} id="previous">
          <img src="img/previous-arrow.png" className={styles.photoButtons} />
        </button>
        <div className={styles.posterBox}>
          <img
            src="/img/carousel-1.jpg"
            alt=""
            className={styles.horizentalPosters}
            id="first"
          />
          <img
        ...
        <div className={styles.mobilePosters}>
          <img
            src="/img/vertical-carousel-1.png"
            alt=""
            className={styles.verticalPosters}
            id="vertical-one"
          />
          <img
            src="/img/vertical-carousel-2.png"
            alt=""
            className={styles.verticalPosters}
            id="vertical-two"
          />
        ...
        <button className={styles.photoBtnBox} id="next">
          <img src="img/next-arrow.png" className={styles.photoButtons} />
        </button>
      </div>
